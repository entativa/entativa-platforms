"""
Recommendation models for Vignette
"""
...
class RecommendationType(str, Enum):
    """Vignette-specific recommendation types"""
    CREATORS_FOR_YOU = "creators_for_you"  # Creator recommendations
    SUGGESTED_FOR_YOU = "suggested_for_you"  # User suggestions
