...
import (
	...
	"vignette/meta-user-service/internal/config"
	"vignette/meta-user-service/internal/handler"
	"vignette/meta-user-service/internal/repository"
	"vignette/meta-user-service/internal/service"
	"vignette/meta-user-service/pkg/cache"
	"vignette/meta-user-service/pkg/database"
	"vignette/meta-user-service/pkg/kafka"
