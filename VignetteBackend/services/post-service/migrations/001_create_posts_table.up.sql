...
CREATE TABLE IF NOT EXISTS posts (
    ...
    media_ids JSONB NOT NULL, -- Required for Instagram
    location JSONB,
...
-- GIN index for hashtags (Instagram's core feature)
...
COMMENT ON TABLE posts IS 'Instagram-style posts with required media attachments';
...
COMMENT ON COLUMN posts.filter_used IS 'Instagram filter applied to media';
