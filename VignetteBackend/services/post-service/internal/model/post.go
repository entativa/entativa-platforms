...
// Post represents an Instagram-style post (image/video required)
type Post struct {
	ID            uuid.UUID      `json:"id" db:"id"`
	UserID        uuid.UUID      `json:"user_id" db:"user_id"`
	Caption       string         `json:"caption" db:"caption"`
	MediaIDs      MediaIDList    `json:"media_ids" db:"media_ids"` // Required for Vignette
...
// Save represents a saved post (Instagram bookmark feature)
type Save struct {
	ID        uuid.UUID  `json:"id" db:"id"`
	UserID    uuid.UUID  `json:"user_id" db:"user_id"`
	PostID    uuid.UUID  `json:"post_id" db:"post_id"`
...
// Location for Instagram-style location tagging
