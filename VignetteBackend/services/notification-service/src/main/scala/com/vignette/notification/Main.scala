package com.vignette.notification
...
import com.vignette.notification.actor._
import com.vignette.notification.api._
import com.vignette.notification.service._
import com.vignette.notification.repository._
    ...
    path("health") {
      get {
        complete(StatusCodes.OK, Map(
          "status" -> "healthy",
          "service" -> "Vignette Notification Service",
          "version" -> "1.0.0"
        ))
      }
    },
