...
// @Description Create a new Socialink account with instant access (Meta-level authentication)
// @Tags auth
// @Accept json
// @Produce json
...
func (h *AuthHandler) Signup(c *gin.Context) {
	...
	if err != nil {
		...
		if errors.Is(err, service.ErrInvalidBirthday) {
			c.JSON(http.StatusBadRequest, gin.H{
