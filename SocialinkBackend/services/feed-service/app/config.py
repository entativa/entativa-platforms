"""
Configuration for Socialink Feed Service
"""
...
class Settings(BaseSettings):
    ...
    # Service
    SERVICE_NAME: str = "socialink-feed-service"
    HOST: str = "0.0.0.0"
    PORT: int = 8086
    DEBUG: bool = False
    ...
    MONGODB_DB: str = "socialink_feed"
    
    POSTGRES_URL: str = "postgresql://postgres:postgres@localhost:5432/socialink_feed"
    ...
    ELASTICSEARCH_INDEX: str = "socialink_content"
